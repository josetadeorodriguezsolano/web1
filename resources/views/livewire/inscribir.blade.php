    ...
    <div class="p-6 bg-white rounded-lg shadow-md">
        ...
        <form wire:submit.prevent="registrarAlumno">
            <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                <!-- Datos personales -->
                <div class="space-y-4">
                    <h3 class="text-lg font-medium text-gray-700 border-b pb-2">Datos Personales</h3>
                    ...
                    <div>
                        ...
                        <input type="text" id="curp" wire:model="alumno.curp"
                            class="uppercase mt-1 block w-full rounded-md border-gray-300 shadow-sm focus:border-blue-500 focus:ring-blue-500"
                            maxlength="18" placeholder="Ej: GAPE050823HDFRCR01">
                        @error('alumno.curp')
                            <span class="text-red-600 text-sm">{{ $message }}</span>
                        @enderror
                        <span class="text-xs text-gray-500">Formato: 18 caracteres alfanuméricos (obligatorio)</span>
                    </div>
                </div>

                <!-- Información académica y de contacto -->
                <div class="space-y-4">
                    <h3 class="text-lg font-medium text-gray-700 border-b pb-2">Información Académica y Contacto</h3>
                    ...
                    <!-- Contacto (teléfono) -->
                    <div>
                        <label for="contacto" class="block text-sm font-medium text-gray-700">Teléfono de Contacto</label>
                    ...
                    <!-- Tutor -->
                    <div>
                        <label for="tutor" class="block text-sm font-medium text-gray-700">Nombre del Tutor</label>
                    ...
                    <!-- Selección de Grupo -->
                    <div>
                        <label for="grupo" class="block text-sm font-medium text-gray-700">Inscribir en Grupo</label>
            ...
            <div class="mt-8 flex justify-end space-x-3">
                ...
                <button type="submit"
                    class="inline-flex items-center px-4 py-2 border border-transparent rounded-md shadow-sm text-sm font-medium text-white bg-[#1E3A8A] hover:bg-blue-900 focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-blue-500">
                    Inscribir Alumno
                </button>
            </div>
        </form>
            ...
            <table class="min-w-full divide-y divide-gray-200">
                ...
                <tbody class="bg-white divide-y divide-gray-200">
                    ...
                    <tr>
                        ...
                        <td class="px-6 py-4 whitespace-nowrap text-sm text-gray-500">{{ $alumno['apellidos'] }} {{ $alumno['nombres'] }}</td>
                        <td class="px-6 py-4 whitespace-nowrap text-sm text-gray-500">{{ $alumno['grupo'] }}</td>
                        <td class="px-6 py-4 whitespace-nowrap text-sm text-gray-500">{{ $alumno['tutor'] }}</td>
                    </tr>
                    @endforeach
                </tbody>
            </table>
