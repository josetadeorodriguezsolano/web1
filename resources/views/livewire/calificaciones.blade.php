            ...
            <table class="w-full divide-y divide-gray-200 border-collapse">
                <thead class="bg-[#1E3A8A]">
                    <tr>
                        ...
                        <th class="py-2 text-center text-xl font-medium text-white uppercase tracking-wide" style="width: 12%; padding: 0;">Unidad 3</th>
                        <th class="py-2 text-center text-xl font-medium text-white uppercase tracking-wide" style="width: 12%; padding: 0;">Unidad 4</th>
                        <th class="py-2 text-center text-xl font-medium text-white uppercase tracking-wide" style="width: 12%; padding: 0;">Promedio</th>
                    </tr>
                </thead>
